...
namespace Managers
{
    public class EnemyController : MonoBehaviour
    {
        ...
        [Tooltip("How many enemies spawn in one time unit")] [SerializeField]
        ...
        private float enemySmallThreshold;

        [Tooltip("Largest value (inclusive) for spawning medium enemies")] [SerializeField]
        private float enemyMediumThreshold;

        [Tooltip("Upper bound (exclusive) for spawning largest enemies")] [SerializeField]
        private int maxRandomiserValue;
